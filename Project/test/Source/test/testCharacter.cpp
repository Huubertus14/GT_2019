	...
	if (ProjectileClass != NULL)
	{
		...
		if (World != NULL)
		{
			...
			else
			{
				...
				World->SpawnActor<AtestProjectile>(ProjectileClass, SpawnLocation, SpawnRotation, ActorSpawnParams);
			}
		}
	}
...
void AtestCharacter::BeginTouch(const ETouchIndex::Type FingerIndex, const FVector Location)
{
...
void AtestCharacter::EndTouch(const ETouchIndex::Type FingerIndex, const FVector Location)
{
...
//void AtestCharacter::TouchUpdate(const ETouchIndex::Type FingerIndex, const FVector Location)
//{
...
bool AtestCharacter::EnableTouchscreenMovement(class UInputComponent* PlayerInputComponent)
{
	if (FPlatformMisc::SupportsTouchInput() || GetDefault<UInputSettings>()->bUseMouseForTouch)
	{
		PlayerInputComponent->BindTouch(EInputEvent::IE_Pressed, this, &AtestCharacter::BeginTouch);
		PlayerInputComponent->BindTouch(EInputEvent::IE_Released, this, &AtestCharacter::EndTouch);

		//Commenting this out to be more consistent with FPS BP template.
		//PlayerInputComponent->BindTouch(EInputEvent::IE_Repeat, this, &AtestCharacter::TouchUpdate);
		return true;
	}
